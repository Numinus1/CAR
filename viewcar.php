...
echo "Proposal:<br> <textarea name=\"proposal\" rows=\"5\" cols=\"200\"  disabled=\"disabled\" >$Proposal</textarea><br><br>";

echo "Attachments: ";
$getpicssql = "SELECT * FROM attachments WHERE carid = $editID";

...
<head>
<title> Propose CAR Solution</title>
<style>
body {
...
echo "Proposed Solution: <br> <textarea name = \"proposal\" rows = \"5\" cols = \"200\" >$Proposal</textarea>";
echo" 

<br><br><br><input type = \"submit\" name = \"create car\"/>

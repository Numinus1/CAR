...
<html>
<head>
<title> Display Assigned CARs </title>


<?php
$uid0 = $_SESSION["uid"];
$query1 = "SELECT * FROM carbasic WHERE EmployeeID = $uid0";
...
echo"</td><td><form action=\"upload.php?RE=2&ID=" . $row['ID'] . "\" method=\"post\" enctype=\"multipart/form-data\">
...
echo "<td><a href='proposeCAR.php?ID=".$row['ID']."' target=\"_blank\" >Propose Solution</a></td>";
echo "</tr><br>";
$k++;
}
echo "</table>";
